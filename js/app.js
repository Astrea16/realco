(() => {
    ...
    function formRating() {
        ...
        function formRatingInit(rating, ratingSize) {
            ...
            for (let index = 0; index < ratingSize; index++) {
                ...
                ratingItems += `\n\t\t\t\t<label for="${index + 1}" class="rating__item">\n\t\t\t\t\t<input id="${index + 1}" class="rating__input" type="radio" name="rating" value="${index + 1}">\n\t\t\t\t</label>`;
    ...
    if (menuLinkSearch) {
        ...
        menuLinkSearch.addEventListener("click", (function() {
            headerForm.classList.contains("_open") ? headerForm.classList.remove("_open") : headerForm.classList.add("_open");
        }));
    }
    ...
    document.querySelector("#up-header-button").addEventListener("click", (function() {
        const upHeader = document.querySelector("#up-header");
        const menuBefore = document.querySelector(".menu__body");
        upHeader.style.opcity = "0";
        upHeader.style.height = "0";
        menuBefore.classList.add("_top");
        setTimeout((function() {
            upHeader.style.display = "none";
            const header = document.querySelector("#header");
            const headerDown = document.querySelector("#header-down");
            header.style.height = headerDown.offsetHeight + "px";
            updateContentPadding();
        }), 200);
    }));
    isWebp();
